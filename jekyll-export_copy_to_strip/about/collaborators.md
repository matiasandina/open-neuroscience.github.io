...
<div id="pl-1412"  class="panel-layout" >
      ...
      <div id="panel-1412-1-1-0" class="so-panel widget widget_sow-editor panel-first-child panel-last-child" data-index="2" >
        <div class="so-widget-sow-editor so-widget-sow-editor-base">
          ...
          <div class="siteorigin-widget-tinymce textwidget">
            ...
            <p>
              My latest project is<a href="http://www.prometheus-science.com"> Prometheus Science</a>, a project dedicated to bringing open source scientific equipment to the masses. 
            </p>
          </div>
        </div>
      </div>
  ...
  <div id="pg-1412-2"  class="panel-grid panel-no-style" >
    <div id="pgc-1412-2-0"  class="panel-grid-cell" >
      <div id="panel-1412-2-0-0" class="so-panel widget widget_sow-image panel-first-child panel-last-child" data-index="3" >
        <div class="panel-widget-style panel-widget-style-for-1412-2-0-0" >
          <div class="so-widget-sow-image so-widget-sow-image-default-9e7b621efa2e">
            <div class="sow-image-container">
              <img src="https://i2.wp.com/openeuroscience.com/wp-content/uploads/2017/12/Agustin_solano.jpg?resize=800%2C1066" width="800" height="1066" srcset="https://i2.wp.com/openeuroscience.com/wp-content/uploads/2017/12/Agustin_solano.jpg?w=1500 1500w, https://i2.wp.com/openeuroscience.com/wp-content/uploads/2017/12/Agustin_solano.jpg?resize=225%2C300 225w, https://i2.wp.com/openeuroscience.com/wp-content/uploads/2017/12/Agustin_solano.jpg?resize=768%2C1024 768w" 		class="so-widget-image" data-recalc-dims="1" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="pgc-1412-2-1"  class="panel-grid-cell" >
      <div id="panel-1412-2-1-0" class="so-panel widget widget_sow-editor panel-first-child panel-last-child" data-index="4" >
        <div class="so-widget-sow-editor so-widget-sow-editor-base">
          <h3 class="widget-title">
            Agustín solano
          </h3>
          ...
          <div class="siteorigin-widget-tinymce textwidget">
            <p>
              <span style="font-weight: 400;">I grew up in Salta (Argentina) and I studied Bioengineering at the National University of Entre Rios. After getting my degree I worked as hardware and firmware developer of a biological signals amplifier and six months later I started a PhD at the Physiology of Action Lab (School of Medicine, University of Buenos Aires).</span>
            </p>
            
            <p>
              <span style="font-weight: 400;">I study motor memories in humans under a visuomotor adaptation paradigm. Particularly I am working with sleep and memories (behavior and EEG during wakefulness and sleep). I am looking for indicators of learning during sleep for explicit and implicit tasks.</span>
            </p>
          </div>
        </div>
      </div>
  ...
  <div id="pg-1412-3"  class="panel-grid panel-no-style" >
    <div id="pgc-1412-3-0"  class="panel-grid-cell" >
      <div id="panel-1412-3-0-0" class="so-panel widget widget_sow-image panel-first-child panel-last-child" data-index="5" >
        <div class="panel-widget-style panel-widget-style-for-1412-3-0-0" >
          <div class="so-widget-sow-image so-widget-sow-image-default-bd5cd9da0588">
            <div class="sow-image-container">
              <img src="https://i2.wp.com/openeuroscience.com/wp-content/uploads/2018/02/Sin-nombre.png?resize=559%2C512" width="559" height="512" srcset="https://i2.wp.com/openeuroscience.com/wp-content/uploads/2018/02/Sin-nombre.png?w=559 559w, https://i2.wp.com/openeuroscience.com/wp-content/uploads/2018/02/Sin-nombre.png?resize=300%2C275 300w" title="Gaspar Herrera photo" 		class="so-widget-image" data-recalc-dims="1" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="pgc-1412-3-1"  class="panel-grid-cell" >
      <div id="panel-1412-3-1-0" class="so-panel widget widget_sow-editor panel-first-child panel-last-child" data-index="6" >
        <div class="so-widget-sow-editor so-widget-sow-editor-base">
          <h3 class="widget-title">
            Gaspar Herrera
          </h3>
  ...
  <div id="pg-1412-4"  class="panel-grid panel-no-style" >
    <div id="pgc-1412-4-0"  class="panel-grid-cell" >
      <div id="panel-1412-4-0-0" class="so-panel widget widget_sow-image panel-first-child panel-last-child" data-index="7" >
        <div class="panel-widget-style panel-widget-style-for-1412-4-0-0" >
          <div class="so-widget-sow-image so-widget-sow-image-default-9e7b621efa2e">
            <div class="sow-image-container">
              <img src="https://i1.wp.com/openeuroscience.com/wp-content/uploads/2017/11/Jesus_Ballesteros_Pic.jpg?resize=800%2C940" width="800" height="940" srcset="https://i1.wp.com/openeuroscience.com/wp-content/uploads/2017/11/Jesus_Ballesteros_Pic.jpg?w=1268 1268w, https://i1.wp.com/openeuroscience.com/wp-content/uploads/2017/11/Jesus_Ballesteros_Pic.jpg?resize=255%2C300 255w, https://i1.wp.com/openeuroscience.com/wp-content/uploads/2017/11/Jesus_Ballesteros_Pic.jpg?resize=768%2C902 768w, https://i1.wp.com/openeuroscience.com/wp-content/uploads/2017/11/Jesus_Ballesteros_Pic.jpg?resize=871%2C1024 871w" 		class="so-widget-image" data-recalc-dims="1" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="pgc-1412-4-1"  class="panel-grid-cell" >
      <div id="panel-1412-4-1-0" class="so-panel widget widget_sow-editor panel-first-child panel-last-child" data-index="8" >
        <div class="so-widget-sow-editor so-widget-sow-editor-base">
          <h3 class="widget-title">
  ...
  <div id="pg-1412-6"  class="panel-grid panel-no-style" >
